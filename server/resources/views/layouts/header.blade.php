  <header class="g s r vd ya cj backdrop-blur-lg" :class="{ 'hh sm _k dj bl ll backdrop-blur-lg' : stickyMenu }"
      ...
      <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
        <nav>
          <ul class="tc _o sf yo cg ep">
            ...
            <li><a href="#furnitures" class="xl">Furnitures</a></li>
        ...
        <div class="tc wf ig pb no">
          ...
          <a href="#support" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }"
            class="lk gh dk rg tc wf xf _l gi hi">Contact Now</a>
        </div>
      </div>
    </div>
  </header>